...
if ($NATS_Session->userlevel<5) UL_Error("Edit Group");
ob_end_flush();
Screen_Header("Group Editor",1,1,"","main","groups");
...
$NATS->DB->Free($r);
echo "<b class=\"subtitle\">Editing <a href=main.php?mode=groups>Group</a>: <a href=group.php?groupid=".$_REQUEST['groupid'].">".$row['groupname']."</a></b><br><br>";

$t="<b class=\"sectitle\">Group Settings</b>";
Start_Round($t,600);
...
echo "</select> [ <a href=\"javascript:showIcons()\">Show Icons</a> ]";
echo "</td></tr>";


echo "<tr><td colspan=2>";
echo "<input type=submit value=\"Save Group Settings\"> <a href=main.php>Cancel Changes</a>";
echo "<br><br>";
echo "</td></tr>";
echo "</form>";
echo "</table>";
...
echo "<br>";
$t="<b class=\"sectitle\">Group Members</b>";
Start_Round($t,600);
...
$NATS->DB->Free($r);
echo "<tr><td colspan=\"2\"><input type=submit value=\"Update Group Member List\"></td></tr>";
echo "</form></table>";
End_Round();
?>
