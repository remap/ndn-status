...
$t="<b class=\"sectitle\">Nodeside Test ".$row['testtype']." on ".$row['nodeid']."</b>";
Start_Round($t,600);
...
echo "<tr><td align=right>Test Alerts :</td>";
echo "<td align=left>";
...
echo "<tr><td align=right>Recorded :</td>";
echo "<td align=left>";
...
echo "<tr><td align=right>Simple Evaluation :</td>";
echo "<td align=left>";
...
echo "<tr><td align=right>Last Checked :</td>";
echo "<td align=left>".nicedt($row['lastrunx'])." - ".dtago($row['lastrunx'])."</td></tr>";
echo "<tr><td align=right>Last Result :</td>";
echo "<td align=left>";
echo "<b class=\"al".$row['alertlevel']."\">";
echo oText($row['alertlevel']);
echo "</b>";
echo "</td></tr>";
echo "<tr><td align=right>Last Value :</td>";
echo "<td align=left>".$row['lastvalue']."</td></tr>";
echo "<tr><td colspan=2><hr class=\"nspacer\"></td></tr>";

echo "<tr><td>&nbsp;</td><td align=left><input type=submit value=\"Save Changes\"> ";
echo "<a href=node.edit.php?nodeid=".$row['nodeid'].">Abandon Changes</a>";
echo "</td></tr></form>";
echo "</table>";
